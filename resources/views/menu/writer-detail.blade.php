                ...
                @foreach ($details as $detail)
                    <div style="display: flex; background-color: #fff; border-radius: 10px; overflow: hidden;">
                        ...
                        <div style="flex: 2; padding: 15px; display: flex; flex-direction: column;">
                            ...
                            <a href="{{ route('materi.detail', ['categoryId' => $detail->categories->id, 'detailId' => $detail->id]) }}" 
                            style="align-self: flex-end; padding: 8px 50px; background-color: #000; color: #fff; text-decoration: none; border-radius: 50px; font-size: 12px;">read more...</a>
                        </div>
                    </div>
                @endforeach
            </div>
